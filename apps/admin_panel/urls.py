...
urlpatterns = [
    ...
    path("users/<uuid:user_id>/trips/", AdminUserTripsView.as_view(), name="admin_user_trips"),
    path("users/<uuid:user_id>/shipments/", AdminUserShipmentsView.as_view(), name="admin_user_shipments"),
